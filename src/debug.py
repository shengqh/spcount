# In order to run the code directly for debug, I will need to run python spcount/__main__py directly.
# Unfortunately, it will cause error:
#   File "spcount/__main__.py", line 7, in <module>
...
from spcount.__main__ import main
